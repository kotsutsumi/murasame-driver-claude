...
export class FakeReadable implements ClaudeReadableStream {
...
export class FakeWritable implements ClaudeWritableStream {
  readonly target = new EventTarget();
...
export class FakeChild implements ClaudeChildProcess {
  readonly target = new EventTarget();
...
export class FakeSpawner implements ClaudeProcessSpawner {
...
export function makeRuntime() {
  return createRuntime({
    sessionId: asSessionId("session-driver-claude-test"),
  });
}
